$(document).ready(function() {
  ...
  $('#submit').click(function() {
    ...
    for (let i = 0; i < guessArray.length; i++) {      
      ...
      if ((guessArray[i] === codeArray[i]) && $(`.row.active .cdMkr-spot-${i + 1}`).css('background-color') != color4) {
        console.log('cdMkr-1 NOT black')
        $('.row.active .cdMkr-spot-1').css('background-color', color4);
      } else if ((guessArray[i] === codeArray[i]) && $(`.row.active .cdMkr-spot-${i + 1}`).css('background-color') != color4) {
          console.log('cdMkr-2 NOT black')
          $('.row.active .cdMkr-spot-2').css('background-color', color4);
      } else if ((guessArray[i] === codeArray[i]) && $(`.row.active .cdMkr-spot-${i + 1}`).css('background-color') != color4) {
          console.log('cdMkr-3 NOT black')
          $('.row.active .cdMkr-spot-3').css('background-color', color4);
      } else if ((guessArray[i] === codeArray[i]) && $(`.row.active .cdMkr-spot-${i + 1}`).css('background-color') != color4) {
          console.log('cdMkr-4 NOT black')
